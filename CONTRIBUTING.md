Contributing to GRVS Core
============================

The GRVS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GRVS Core project, and is not to be
confused with overall GRVS Network Protocol consensus changes.

Whether a pull request is merged into GRVS Core rests with the project merge
...
Patches that change GRVS consensus rules are considerably more involved than
...
Where a patch set proposes to change the GRVS consensus, it must have been
...
The project leader is the release manager for each GRVS Core release.
