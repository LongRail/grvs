...
In order to support loading of multiple wallets in grvs-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is grvs.cpp.
...
Changes to grvs.cpp
----------------------
grvs.cpp is the entry point into grvs-qt, and as such, will require some minor modifications to provide hooks for
