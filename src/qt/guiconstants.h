...
/* GRVS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GRVS"
#define QAPP_ORG_DOMAIN "grvs.cc"
#define QAPP_APP_NAME_DEFAULT "GRVS-Qt"
#define QAPP_APP_NAME_TESTNET "GRVS-Qt-testnet"
