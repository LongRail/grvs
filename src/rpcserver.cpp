...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GRVS features */
        {"grvs", "masternode", &masternode, true, true, false},
        {"grvs", "listmasternodes", &listmasternodes, true, true, false},
        {"grvs", "getmasternodecount", &getmasternodecount, true, true, false},
        {"grvs", "masternodeconnect", &masternodeconnect, true, true, false},
        {"grvs", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"grvs", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"grvs", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"grvs", "masternodecurrent", &masternodecurrent, true, true, false},
        {"grvs", "masternodedebug", &masternodedebug, true, true, false},
        {"grvs", "startmasternode", &startmasternode, true, true, false},
        {"grvs", "createmasternodekey", &createmasternodekey, true, true, false},
        {"grvs", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"grvs", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"grvs", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"grvs", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"grvs", "getmasternodescores", &getmasternodescores, true, true, false},
        {"grvs", "mnbudget", &mnbudget, true, true, false},
        {"grvs", "preparebudget", &preparebudget, true, true, false},
        {"grvs", "submitbudget", &submitbudget, true, true, false},
        {"grvs", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"grvs", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"grvs", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"grvs", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"grvs", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"grvs", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"grvs", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"grvs", "checkbudgets", &checkbudgets, true, true, false},
        {"grvs", "mnsync", &mnsync, true, true, false},
        {"grvs", "spork", &spork, true, true, false},
        {"grvs", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> grvs-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37822/\n";
}
