...
RESOURCES += src/qt/grvs.qrc src/qt/grvs_locale.qrc

TRANSLATIONS += src/qt/locale/grvs_bg.ts \
                src/qt/locale/grvs_de.ts \
                src/qt/locale/grvs_en.ts \
                src/qt/locale/grvs_es.ts \
                src/qt/locale/grvs_fi.ts \
                src/qt/locale/grvs_fr.ts \
                src/qt/locale/grvs_it.ts \
                src/qt/locale/grvs_ja.ts \
                src/qt/locale/grvs_pl.ts \
                src/qt/locale/grvs_pt.ts \
                src/qt/locale/grvs_ru.ts \
                src/qt/locale/grvs_sk.ts \
                src/qt/locale/grvs_sv.ts \
                src/qt/locale/grvs_vi.ts \
                src/qt/locale/grvs_zh_CN.ts \
                src/qt/locale/grvs_zh_TW.ts
