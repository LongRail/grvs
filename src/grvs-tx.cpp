...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GRVS Core grvs-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  grvs-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded grvs transaction") + "\n" +
                               "  grvs-tx [options] -create [commands]   " + _("Create hex-encoded grvs transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded grvs transaction
