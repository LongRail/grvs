...
This mechanism has been integrated into Bitcore-Node-GRVS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GRVS-Project/insight-api-grvs#web-socket-api](https://github.com/GRVS-Project/insight-api-grvs#web-socket-api) 
* API: [https://github.com/GRVS-Project/insight-api-grvs#swifttx-transactions](https://github.com/GRVS-Project/insight-api-grvs#swifttx-transactions) 
...
By default, the GRVS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GRVS Core daemon:
