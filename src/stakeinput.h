...
#ifndef GRVS_STAKEINPUT_H
#define GRVS_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZGRVS() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zGRVSStake can take two forms
...
public:
    ...
    bool IsZGRVS() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZGRVS() override { return false; }
};


#endif //GRVS_STAKEINPUT_H
