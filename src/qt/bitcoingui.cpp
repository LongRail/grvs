                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GRVS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GRVS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and grvs: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGRVS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GRVS Core"), this);
    aboutAction->setStatusTip(tr("Show information about GRVS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GRVS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GRVS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GRVS addresses"));
    ...
    openAction->setStatusTip(tr("Open a GRVS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GRVS Core help message to get a list with possible GRVS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GRVS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GRVS network", "", count));
}
...
{
    QString strTitle = tr("GRVS Core"); // default title
